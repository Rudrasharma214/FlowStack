        ...
        {!subscription ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div
                className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${subscription.auto_renew ? 'bg-amber-500' : 'bg-gray-200 dark:bg-zinc-700'}`}
              >
                <span
                  className={`inline-block h-3 w-3 transform rounded-full bg-white transition ${subscription.auto_renew ? 'translate-x-5' : 'translate-x-1'}`}
                />
              </div>
            </div>
